...
const ResourceUpload = ({ title, description, href }) => (
  <Grid.Column>
    <a href={href} target="_blank" className="resource-upload-content">
      <span className="resource-upload-header">{title}</span>
  ...
  return (
    <>
      <ResourceUpload
        ...
        href="https://www.usbr.gov/pn/hydromet/klamath/teacup.html"
      />
      <ResourceUpload
        ...
        href="https://waterdata.usgs.gov/monitoring-location/11507001/#parameterCode=62615&period=P7D&showMedian=true"
      />
      <ResourceUpload
        ...
        href="https://waterdata.usgs.gov/monitoring-location/11501000/#parameterCode=00065&period=P7D"
      />
      <ResourceUpload
        ...
        href="https://waterdata.usgs.gov/monitoring-location/11502500/#parameterCode=00060&period=P365D&showMedian=true"
      />
      <ResourceUpload
        title="USGS Klamath River Basin Water Quality Mapper"
        description="A Klamath River Basin water quality mapper built by the USGS, with links href most recent continuous and discrete data for each site."
        // description="A Klamath River Basin water quality mapper built by the U.S. Geological Survey. Tool provides a monitoring location map with links href most recent continuous and discrete data for each site. Only data collected by the Bureau of Reclamation and the USGS are included."
        href="https://or.water.usgs.gov/proj/klamath_wq_mapper/"
      />
      <ResourceUpload
        ...
        href="https://or.water.usgs.gov/projs_dir/klamath_wells/#"
      />
    </>
  )
}
